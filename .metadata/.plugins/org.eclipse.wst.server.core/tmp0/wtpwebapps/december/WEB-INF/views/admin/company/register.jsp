			   ...
			   <form id="form" role="form" method="post" enctype="multipart/form-data">
				...
				<div class="form-inline">
	               	<div class="form-group">
	                	<label>사업자등록번호</label>
	                	<input type="text" name="taxId" id="taxId" maxlength="10" class="form-control" required="required">
	               	</div>
	               	<div class="form-group">
	                	<label>상호(법인명)</label>
               	...
               	<button type="submit" class="btn btn-default btn-sm">납품업체등록</button>
