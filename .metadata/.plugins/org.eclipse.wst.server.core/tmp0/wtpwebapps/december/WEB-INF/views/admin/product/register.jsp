			   ...
			   <form id="form" role="form" method="post" enctype="multipart/form-data">
				...
				<div class="form-inline">
	               	<div class="form-group">
	                	<label>물품코드</label>
	                	<input type="text" name="productCode" id="productCode" maxlength="3" class="form-control" disabled="disabled">
	               	</div>
	               	<div class="form-group">
	                	<label>물품이름</label>
               	...
               	<button type="submit" class="btn btn-default btn-sm">물품등록</button>
